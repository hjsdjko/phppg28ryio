...
class ApiController extends CommonController
{
    ...
    public function download()
    {
        ...
        header('location:http://' . $_SERVER['HTTP_HOST'] . '/phppg28ryio/upload/' . $fileName);
        exit; 
    }
    /**
     * 获取某表的某个字段列表接口
    ...
    public function group($tablesName,$columnName){
        ...
        if ($tokens['isAdmin']!=1 || ($tokens['isAdmin']==1 && $tokens['tablename'] != "users")){
            ...
            if($tokens['tablename'] == 'quxiaoyuyue'){
                if($tokens['tablename'] == 'xueyuan'){
                    $where .= " and `xueyuanzhanghao` = '".$tokens['username']."' ";
                }
            }
            ...
            if($tokens['tablename'] == 'qiandaoxinxi'){
                if($tokens['tablename'] == 'xueyuan'){
                    $where .= " and `xueyuanzhanghao` = '".$tokens['username']."' ";
                }
            }
            ...
            if($tokens['tablename'] == 'xueshengqingjia'){
                if($tokens['tablename'] == 'xueyuan'){
                    $where .= " and `xueyuanzhanghao` = '".$tokens['username']."' ";
                }
            }
            ...
            if($tokens['tablename'] == 'jiaoshiqingjia'){
                if($tokens['tablename'] == 'jiaoshi'){
                    $where .= " and `jiaoshixingming` = '".$tokens['username']."' ";
                }
            }
            if($tokens['tablename'] == 'kebiaoxinxi'){
                if($tokens['tablename'] == 'jiaoshi'){
                    $where .= " and `jiaoshixingming` = '".$tokens['username']."' ";
                }
            }
    ...
    public function value($tableName,$xColumnName,$yColumnName,$tjType){
        ...
        $where = " where 1 ";
        if ($tokens['isAdmin']!=1 || ($tokens['isAdmin']==1 && $tokens['tablename'] != "users")){
            if($tableName == 'kechengxinxi'){
                if($tokens['tablename'] == 'jiaoshi'){
                    $where .= " and `jiaoshixingming` = '".$tokens['username']."' ";
                }
            }
            if($tableName == 'baomingjiaofei'){
                if($tokens['tablename'] == 'xueyuan'){
                    $where .= " and `xueyuanzhanghao` = '".$tokens['username']."' ";
                }
            }
            if($tableName == 'sijiaoyuyue'){
                if($tokens['tablename'] == 'jiaoshi'){
                    $where .= " and `jiaoshixingming` = '".$tokens['username']."' ";
                }
            }
            ...
            if($tableName == 'jiaoshiqingjia'){
                if($tokens['tablename'] == 'jiaoshi'){
                    $where .= " and `jiaoshixingming` = '".$tokens['username']."' ";
                }
            }
            if($tableName == 'kebiaoxinxi'){
                if($tokens['tablename'] == 'jiaoshi'){
                    $where .= " and `jiaoshixingming` = '".$tokens['username']."' ";
                }
            }
